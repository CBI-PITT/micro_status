...
from micro_status.scheduler_report import post_mesospim_usage, post_rscm_usage
    ...
    for file_path in datasets:
        ...
        if is_new:
            ...
            if not os.path.exists(new_dataset_marker_json):
                path_data = {"path": file_path}
                json.dump(path_data, open(new_dataset_marker_json, "w"))
            # Post RSCM usage to the online scheduler once imaging finished;
